...
class UserSigner(signing.TimestampSigner):
    ...
    def check_token(self, user, token, max_age=None):
        self.unsign(self.sep.join((self._make_hash_value(user), token), max_age))
    ...
    def unsign(self, value, max_age=None):
        ...
        Returns:
            django.contrib.auth.models.BaseUser: Return user object for given
            access token.
